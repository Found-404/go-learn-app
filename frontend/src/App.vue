...
import { Plus, Trash2, CheckCircle, Circle, Loader2, ListTodo, Share2 } from 'lucide-vue-next'
...
const view = ref<'todo' | 'mindmap'>('todo')
...
<template>
  <div class="app-container">
    <nav class="side-nav">
      ...
      <button 
        :class="['nav-item', { active: view === 'todo' }]" 
        @click="view = 'todo'"
      >
        <ListTodo :size="20" />
        <span>待办清单</span>
      ...
      <button 
        :class="['nav-item', { active: view === 'mindmap' }]" 
        @click="view = 'mindmap'"
      >
        <Share2 :size="20" />
        <span>思维导图</span>
